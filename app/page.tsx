  ...
  return (
    <main className="min-h-screen" data-stage={stage}>
      ...
      {showLevelBadge && writingAssessment && (
        <div className="fixed right-3 top-14 z-[100] sm:right-5 sm:top-16 lg:right-6">
          <LevelBadge level={Math.min(5, Math.max(1, writingAssessment.level))} className="text-sm sm:text-base lg:text-lg" />
        </div>
      )}
      {stage === "login" && (
        <LoginPage
