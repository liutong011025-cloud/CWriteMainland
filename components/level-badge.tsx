  ...
  return (
    <div className={`relative z-40 ${className}`} ref={ref}>
      <button
        type="button"
        onClick={() => setOpen((o) => !o)}
        className={`flex items-center gap-2 rounded-lg border-2 border-amber-400/90 bg-gradient-to-r from-amber-100 to-yellow-100 px-3 py-2 text-sm font-bold text-amber-900 shadow-lg transition hover:from-amber-200 hover:to-yellow-200 focus:outline-none focus:ring-2 focus:ring-amber-500 sm:rounded-xl sm:px-5 sm:py-3 sm:text-base ${className}`}
